...
const softGrey = Color.fromARGB(255, 224, 224, 224);
const statusTaskPending = Colors.white;
const statusTaskInProgress = Colors.green;
const statusTaskDone = disabledGrey;
...
// titles
final kTitleLarge = Theme.of(context).textTheme.titleLarge!;
final kTitleMedium = Theme.of(context!).textTheme.titleMedium!;
final kTitleSmall = Theme.of(context!).textTheme.titleSmall!;
// heads
